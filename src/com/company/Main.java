...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (n!=0) {
            switch (n) {
                case 1: System.out.println("Введите данные о товаре в формате 'код или название товара' 'цена'");
                item_Code = in.next();
                item_price = in.nextInt();
                Item item1 = new Item(item_Code,item_price);
                cart.addItem(item1);
                break;
                case 2: System.out.println("Введите 1, если хотите оплатить через Paypal");
